...
function toolColorState(toolColors) {
  ...
  return {
    ...
    cursorPrimaryColor: rgbToHex(colors.cursor_primary, DEFAULT_TOOL_COLORS.cursorPrimary),
    cursorSecondaryColor: rgbToHex(colors.cursor_secondary, DEFAULT_TOOL_COLORS.cursorSecondary),
...
function taskbarTextColorState(taskbarTextColors) {
  ...
  return {
    ...
    cursorTextColor: rgbToHex(colors.cursor, DEFAULT_TASKBAR_TEXT_COLORS.cursor),
    cursorTextColorOn: boolOr(colors.cursor_on, false),
...
export function formStateFromSettings(settings = {}) {
  ...
  return {
    ...
    taskbarAvoidOverlapOn: boolOr(settings.taskbar_avoid_overlap_on, true),
    taskbarLayoutMemoryOn: boolOr(settings.taskbar_layout_memory_on, true),
    taskbarProfilePresentationOn: boolOr(settings.taskbar_profile_presentation_on, true),
    taskbarProfileColorsOn: boolOr(settings.taskbar_profile_colors_on, false),
    ...
    cursorTaskbarOffsetRatio: ratioOr(settings.cursor_taskbar_offset_ratio, legacyOffset),
    showClaude: settings.show_claude !== false,
    showCodex: settings.show_codex !== false,
    showGrok: settings.show_grok === true,
    showCursor: settings.show_cursor === true,
...
export function payloadFromEntries(entries) {
  ...
  return {
    ...
    taskbar_avoid_overlap_on: isChecked(source.get("taskbar_avoid_overlap_on")),
    taskbar_layout_memory_on: isChecked(source.get("taskbar_layout_memory_on")),
    taskbar_profile_presentation_on: isChecked(source.get("taskbar_profile_presentation_on")),
    taskbar_profile_colors_on: isChecked(source.get("taskbar_profile_colors_on")),
    ...
    cursor_taskbar_offset_ratio: ratioOr(source.get("cursor_taskbar_offset_ratio"), 0),
    ...
    show_cursor: isChecked(source.get("show_cursor")),
    ...
    cursor_primary_color: String(source.get("cursor_primary_color") || DEFAULT_TOOL_COLORS.cursorPrimary),
    cursor_secondary_color: String(source.get("cursor_secondary_color") || DEFAULT_TOOL_COLORS.cursorSecondary),
    ...
    cursor_text_color: String(
      source.get("cursor_text_color") || DEFAULT_TASKBAR_TEXT_COLORS.cursor,
    ),
    cursor_text_color_on: isChecked(source.get("cursor_text_color_on")),
