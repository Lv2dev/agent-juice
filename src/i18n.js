...
const COPY = {
  ...
  en: {
    ...
    "field.restoreStatusline": "Restore Claude statusline",
    ...
    "help.restoreStatusline": "Restores the Claude Code statusline configuration from before Juice connected.",
