...
const COPY = {
  ko: {
    ...
    "effect.breathe": "숨쉬기",
    "about.version": "버전",
    "about.description": "Claude Code, Codex, Grok Build의 사용량을 Windows 작업표시줄에서 확인하는 로컬 모니터입니다.",
  ...
  en: {
    ...
    "about.description": "A local Windows taskbar monitor for Claude Code, Codex, and Grok Build usage.",
