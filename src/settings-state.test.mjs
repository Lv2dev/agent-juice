...
test("formStateFromSettings reads scalar and custom Rust palette shapes", () => {
  assert.deepEqual(
    ...
    }),
    {
      ...
      grokPrimaryColor: "#d15288",
      grokSecondaryColor: "#8269c8",
      cursorPrimaryColor: "#3b82f6",
      cursorSecondaryColor: "#06b6d4",
      ...
      grokTextColor: "#d15288",
      grokTextColorOn: true,
      cursorTextColor: "#3b82f6",
      cursorTextColorOn: true,
...
test("payloadFromEntries creates save_settings input payload", () => {
  const payload = payloadFromEntries({
    ...
    cursor_taskbar_offset_ratio: "0.4",
    show_claude: "on",
    show_codex: "on",
    show_grok: "on",
    show_cursor: "on",
    ...
    grok_primary_color: "#d15288",
    grok_secondary_color: "#8269c8",
    cursor_primary_color: "#3b82f6",
    cursor_secondary_color: "#06b6d4",
    ...
    grok_text_color: "#d15288",
    grok_text_color_on: "on",
    cursor_text_color: "#5b9cff",
    cursor_text_color_on: "on",
